  ...
  return (
    <div className="switch-triple">
      <div className="radio-wrapper">
        ...
        <input type="radio" name="event" className="yes" checked={pago === 'Pendiente'} readOnly id="radio-yes" />
        ...
        <input
          type="radio"
          name="event"
          className={`neutral ${lastAnimation === 'RightToCenter' ? 'DC' : 'IC'}`}
          checked={pago === 'Incompleto'}
          readOnly
          id="radio-neutral"
        />
        <label onClick={(e) => e.stopPropagation()} htmlFor="radio-neutral"></label>

        <input type="radio" name="event" className="no" checked={pago === 'Completo'} readOnly id="radio-no" />
