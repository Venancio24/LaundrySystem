...
export const politicaAbandono = {
  mResaltado: "El plazo máximo para retirar las prendas es de 90 días ",
  mGeneral: `después de entregada a la lavandería, vencido el plazo, se donará a instituciones de caridad. No hay lugar.
  Reclamo: una vez retirada la prenda, no nos responsabilizamos por prendas que se destiñan por malos tintes, botones o
  adornos que no resistan al lavado o planchado, por las prendas que se deterioren por estar demasiado usadas, tejidos y confecciones defectuosas.`,
};
